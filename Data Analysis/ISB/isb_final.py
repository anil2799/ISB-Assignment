def main():
	...
	urllib.urlretrieve("http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=1&p=1&f=G&l=50&d=PTXT&S1=8829700&OS=8829700&RS=8829700","8829700_patent_dwd.html")

	'''
	web_content=page.read()
	f=open('8829700dwd.html','w')
	f.write(web_content)
	f.close
	'''
	...
	print "Patent Number 8829700 downloaded as 8829700_patent_dwd.html"
